%\csvautotabular{gas.csv}

\subsection{Without Pointers}

\todo{overhead here but it's acceptable. optimizer does a lot.}
...
\todo{once you have enough in storage, the rebates take over and are more
