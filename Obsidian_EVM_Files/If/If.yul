...
object "If" {
    code {
        ...
        codecopy(0, dataoffset("If_deployed"), datasize("If_deployed"))
        return(0, datasize("If_deployed"))
    }
    object "If_deployed" {
        code {
            ...
            if iszero(lt(calldatasize(), 4)) {
                    ...
                    switch selector
case 0xb02c4b23 {if callvalue() {revert(0, 0)}
