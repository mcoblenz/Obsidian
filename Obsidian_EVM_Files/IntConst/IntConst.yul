...
object "IntConst" {
    code {
        ...
        codecopy(0, dataoffset("IntConst_deployed"), datasize("IntConst_deployed"))
        return(0, datasize("IntConst_deployed"))
    }
    object "IntConst_deployed" {
        code {
            ...
            if iszero(lt(calldatasize(), 4)) {
                    ...
                    switch selector
case 0xc788266f {if callvalue() {revert(0, 0)}
