...
\author{Celeste Barnaby, Michael Coblenz, Tyler Etzel}
\affiliation{
...
\email{mcoblenz@cs.cmu.edu, tje44@cornell.edu}

\author{Eliezer Kanal, Joshua Sunshine, Brad Myers, Jonathan Aldrich}
\affiliation{
  \institution{Carnegie Mellon University}            
}
\email{ekanal@cert.org, sunshine@cs.cmu.edu,}
\email{bam@cs.cmu.edu, jonathan.aldrich@cs.cmu.edu} 
