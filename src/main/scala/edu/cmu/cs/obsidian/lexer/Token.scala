...
case class MethodT() extends Token { override def toString: String = "method" }
...
case class RevertT() extends Token { override def toString: String = "revert" }
case class NotT() extends Token { override def toString: String = "!" }
case class AndT() extends Token { override def toString: String = "&&" }
case class OrT() extends Token { override def toString: String = "||" }
