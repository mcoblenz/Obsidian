...
TODO: What state is a Bid in at:
    ...
    2. The beginning of the bidSurpassed transaction? ______________________
    3. The end of the bidSurpassed transaction? ______________________
*/

contract Bid {
    Money money;

    enum State { Open, Stale }
    State public state;
