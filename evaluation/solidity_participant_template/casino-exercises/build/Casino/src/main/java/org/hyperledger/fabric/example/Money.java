    ...
    implements ObsidianSerialized
{
        ...
        try {
            if (__isInsideInvocation) {
                ...
                if (amt.compareTo(this.amount) == 1) {
                    throw new ObsidianRevertException("/Users/mcoblenz/code/Obsidian/evaluation/participant_template/betting-exercises/betting_utils.obs", 25, "Can't split out more money than is available in a given Money object.");
                } else {
    ...
    public byte[] __wrappedArchiveBytes()
        throws com.google.protobuf.InvalidProtocolBufferException
    {
        org.hyperledger.fabric.example.BettingOuterClass.MoneyOrGUID.Builder builder = org.hyperledger.fabric.example.BettingOuterClass.MoneyOrGUID.newBuilder();
        builder.setObj(this.archive());
        MoneyOrGUID wrappedObject = builder.build();
        return wrappedObject.toByteArray();
    }

    public org.hyperledger.fabric.example.BettingOuterClass.Money archive()
        throws com.google.protobuf.InvalidProtocolBufferException
    {
        org.hyperledger.fabric.example.BettingOuterClass.Money.Builder builder = org.hyperledger.fabric.example.BettingOuterClass.Money.newBuilder();
    ...
    public void initFromArchive(Object archiveIn, SerializationState __st)
        throws com.google.protobuf.InvalidProtocolBufferException
    {
        org.hyperledger.fabric.example.BettingOuterClass.Money archive = ((org.hyperledger.fabric.example.BettingOuterClass.Money) archiveIn);
    ...
    public Money __initFromArchiveBytes(byte[] archiveBytes, SerializationState __st)
        throws com.google.protobuf.InvalidProtocolBufferException
    {
        org.hyperledger.fabric.example.BettingOuterClass.Money archive = org.hyperledger.fabric.example.BettingOuterClass.Money.parseFrom(archiveBytes);
